...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "1.) Click the browse image button to search for desired image."
        '
        'Label2
        '
        ...
        Me.Label2.Text = "2.) Choose the desired image type from combo box."
        '
        'Label3
        '
        ...
        Me.Label3.Text = "3.) Click the convert button and save the file to desired location."
        '
        'Button1
        '
        ...
        Me.ClientSize = New System.Drawing.Size(315, 98)
